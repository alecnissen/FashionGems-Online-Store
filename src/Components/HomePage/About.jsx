...
export default function About({ numberOfCartItems, isOpen, setIsOpen }) {
  return (
    <>
      ...
      <p>We started in 1968 in Amsterdam. Our grandpa, Jan worked very hard to provide the best Jewelry for the community. He wanted to create lasting memories and make an impact on every customer. 
        Jan instilled in us the service and core values that make our business so unique. Excellent service, knowledge, passion, good humor, to go above and beyond to serve you, and to always respect the customer and community. 
        We carry on the legacy today and Jan's passion lives through all of us. 
      </p>
